...
const News = () => {
  ...
  const [
    trigger,
    { data: dataNews, isError, isLoading, isFetching, isSuccess, error },
    lastPromiseInfo
  ] = useLazyGetAllNewsQuery()
  ...
  return (
    <>
      ...
      {isSuccess && <DataTable columns={columns} data={dataNews.data} />}
      {/* <DataTable columns={columns} data={dataNews} /> */}
    </>
  )
}
export default News

 ...
 */
export const getAllPerformanceEvaluations = handleCatchErrorAsync(async (req, res) => {
 ...
 * @param {Object} res - Express response object
 */
export const deletePerformanceEvaluationById = handleCatchErrorAsync(async (req, res) => {
  const evaluation = await deletePerformanceEvaluationByIdService(req.params.id)
  globalResponse(res, 200, evaluation)
})

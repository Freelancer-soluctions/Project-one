...
- **AND** the digest SHALL flag any license matching the project's documented deny-list (static constant in `generate-security-digest.mjs`, aligned with the sibling dependency-review default deny-list and documented in `docs/security/SECURITY.md`)

...
- [x] 1.3 Add new step "Install opencode" with run script that downloads v1.18.31 from `https://github.com/anomalyco/opencode/releases/download/v1.18.31/opencode-linux-x64.zip`, unzips to `$HOME/.opencode/bin`, makes executable, and adds to `GITHUB_PATH`

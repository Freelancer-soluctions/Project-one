...
| permission | type | 100 |
| permission | reason | 500 |
| permission | comments | 1000 |
| expenses | description | 255 |
| providerOrder | notes | 200 |
...
- Backend Joi schemas were aligned where validation limits mismatched Prisma schema
  - searchTerm/searchQuery unified to max(100)
  - productAttributes.description fixed from 50→100
  - employee dni fixed from 10→128
- Filter forms (10 files) migrated to use FIELD_LIMITS
- Notes local config removed in favor of central FIELD_LIMITS

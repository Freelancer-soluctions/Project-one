...
Provide a configurable rule-based guardrail system that intercepts tool calls during execution, evaluates user-defined rules against tool arguments and context, and either allows or blocks execution with descriptive error messages, audit logging, and graceful error handling.

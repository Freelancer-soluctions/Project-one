...
This capability defines how soft-deleted events are queried. By default, soft-deleted events are excluded from list responses. ADMIN users can optionally view deleted events using a query parameter.

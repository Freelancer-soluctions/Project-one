...
>
> Este documento explica cómo levantar y usar Floci (`floci/floci:v1.5.11`) junto con la aplicación Express para desarrollar contra Secrets Manager emulado sin necesidad de cuenta AWS real.
...
# O directamente:
docker compose exec floci floci health
...
> **`docs/aws-learning-with-floci.md`** — *Ruta de aprendizaje progresiva de AWS (Niveles 1-5), propiedad del change sibling `ci-preview-environments`*.
>

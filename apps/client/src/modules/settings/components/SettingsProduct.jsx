      ...
      <Card className="w-full">
        ...
        <CardContent className="space-y-4">
          <Accordion type="single" collapsible  className="w-full" >
            <AccordionItem value="categories" className="mb-2 border rounded-md shadow-sm border-border bg-card">
            ...
            <AccordionItem value="inventory" className="mb-2 border rounded-md shadow-sm border-border bg-card">
              <AccordionTrigger className="px-4 py-4 hover:bg-accent hover:no-underline rounded-t-md">
                <div className="flex items-center gap-2">
                  <LuBox className="w-5 h-5" />
                  <span className="font-medium">{t("inventory_management")}</span>
                </div>
              </AccordionTrigger>
              <AccordionContent>
                <div className="py-4 text-muted-foreground">{t("inventory_management_placeholder")}</div>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </CardContent>
